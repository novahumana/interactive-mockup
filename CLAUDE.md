...
│   └── patients-table.tsx
├── data/                # Storage logic to persist mock data
├── hooks/               # Custom React hooks
└── lib/
|   ├── constants.ts     # Brand constants & config
|   └── utils.ts         # Utility functions (cn)
├── mocks/               # Mock data defining the initial seed
├── types/               # Typescript types definition
```

## Technical Requirements

**Before implementing any feature, bug fix, or refactor**, load [./docs/index.md](./docs/index.md) and follow the relevant guidelines based on your task.
